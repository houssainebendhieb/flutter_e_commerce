...
class GetProductByCategoryName implements UseCase<Either, dynamic> {
  GetProductByCategoryName(String categoryName);

  @override
  Future<Either<String, List<ProductEntity>>> call({params}) async {
    return await sl<ProductRepo>().getProductsByCategoryName(params);
  }
}
